    ...
    g.extend(b.prototype, {
        init: function () {
            ...
            function A(G, B, F) {
                ...
                val = B.set({year: D, month: E, date: G}).format(this.picker.config.format.split(" ")[0]);
                this.picker.$container.find(".c-datePicker__input-day").val(val);
                var C = F.set({year: D, month: E, date: G}).format(this.picker.config.format);
            ...
            function o(I, D) {
                ...
                if (!I.current) {
                    D.addClass("current");
                    var A = moment().set({year: K, month: J, date: F}).format(I.picker.config.format.split(" ")[0]);
                    G.val(A);
            ...
            var E = moment().set({year: K, month: ac - 1, date: 1}).weekday();
            var F = moment().set({year: K, month: ac - 1, date: T}).weekday();
        ...
        init: function () {
            ...
            if (H.between === "month") {
                if (A.year !== B.year || A.month !== B.month) {
                    var C = D.set({year: B.year, month: B.month - 1, date: 1}).format(H.format);
